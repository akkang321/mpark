...
<script>
    ...
    function employeeInfo(partnerBN) {
        $("#partnerBN").val(partnerBN);
        $("#frm").attr("action", "/admin/getMyPartners");
        $("#frm").submit();
    }

    function parkingLotInfo(partnerBN) {
        $("#partnerBN").val(partnerBN);
        $("#frm").attr("action", "/admin/getParkingLots");
        $("#frm").submit();
    }

    function getVisitPlaces(partnerBN, parkingLN) {
        $("#partnerBN").val(partnerBN);
        $("#parkingLN").val(zerofill_1(parkingLN, 6));
        $("#frm").attr("action", "/admin/getVisitPlaces");
        $("#frm").submit();
    }
...
<form id="frm" method="post" action="">
    ...
    <input type="hidden" id="parkingLN" name="parkingLN">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="PartnersDetailWrap">
                                    <div class="btm">
                                        <div class="tabBox">
                                            <button onclick="partnerInfo(${partnerBN})">상세정보</button>
                                            <button onclick="parkingLotInfo(${partnerBN})">입출차</button>
                                            <button onclick="parkingLotInfo(${partnerBN})" class="active"> 주차장 정보
                                            </button>
                                            </button>
                                            <button onclick="employeeInfo(${partnerBN})">직원목록</button>
                                        ...
                                        <div class="PartnersDetailCon2">
                                            <table>
                                                ...
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td onclick="getVisitPlaces(${partnerBN}, ${list.ParkingLN})" class="active">${list.Name}</td>
