                                ...
                                <div class="PartnersDetailWrap">
                                    <div class="btm">
                                        <div class="tabBox">
                                            ...
                                            <button onclick="employeeInfo(${partnerBN})"> 입출차</button>                                            </button>
                                            <button onclick="parkingLotInfo(${partnerBN})"> 주차장 정보</button>                                            </button>
                                            <button onclick="employeeInfo(${partnerBN})" class="active">직원목록</button>
                                        </div>
