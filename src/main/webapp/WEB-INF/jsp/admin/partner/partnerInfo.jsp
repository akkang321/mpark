                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="PartnersDetailWrap">
                                        <div class="btm">
                                            <div class="tabBox">
                                                <button onclick="partnerInfo(${info.PartnerBN})" class="active">상세정보</button>
                                                <button onclick="partnerInfo(${info.PartnerBN})">입출차</button>
                                                <button onclick="parkingLotInfo(${info.PartnerBN})">주차장 정보</button>
                                                <button onclick="employeeInfo(${info.PartnerBN})">직원목록</button>
                                            </div>
                                        </div>
                                    </div>
